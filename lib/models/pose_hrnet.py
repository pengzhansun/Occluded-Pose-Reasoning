...
class PoseHighResolutionNet(nn.Module):
    def __init__(self, cfg, **kwargs):
        ...
        self.final_layer = nn.Conv2d(
            # in_channels=pre_stage_channels[0],
            in_channels=pre_stage_channels[-1] if cfg.low else pre_stage_channels[0],
            out_channels=cfg['MODEL']['NUM_JOINTS'],
            kernel_size=extra['FINAL_CONV_KERNEL'],
            stride=1,
            # padding=1 if extra['FINAL_CONV_KERNEL'] == 3 else 0
    ...
    def forward(self, x):
        ...
        # print('len_stage4:', len(y_list))

        # print('num_branches:', self.stage4_cfg['NUM_BRANCHES'])
        # print('y_list[0].shape:', y_list[0].shape)
        # print('y_list[1].shape:', y_list[1].shape)
        # print('y_list[2].shape:', y_list[2].shape)
        # print('y_list[3].shape:', y_list[3].shape)
