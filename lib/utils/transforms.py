...
def fliplr_visibility(visibility, matched_parts):
    """
    flip coords visibility identity
    """

    # change left-right parts
    for pair in matched_parts:
        visibility[pair[0], :], visibility[pair[1], :] = \
            visibility[pair[1], :], visibility[pair[0], :].copy()
